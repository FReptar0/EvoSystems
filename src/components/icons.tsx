...
export const MountainIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const TrekkingIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
  ...
  >
    <path
      d="M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zM9.8 8.9L7 23h2.1l1.8-8 2.1 2v6h2v-7.5l-2.1-2 .6-3C14.8 12 16.8 13 19 13v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6c-.4-.6-1-1-1.7-1-.3 0-.5.1-.8.1L9 8.3v4.7h2V9.6l-.2-.7z"
      fill="currentColor"
    />
  </svg>
);
...
export const CompassIcon: React.FC<IconSvgProps> = ({
  ...
  >
    <path
      d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 5-5v10zm2 0v-10l5 5-5 5z"
      fill="currentColor"
    />
  </svg>
);
...
export const MobileIcon: React.FC<IconSvgProps> = ({
  ...
  >
    <path
      d="M17 2H7c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM7 4h10v14H7V4z"
      fill="currentColor"
    />
  </svg>
);

export const WebIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const DesktopIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const IntegrationIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const ERPIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
